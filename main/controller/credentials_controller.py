...
class AdminCredentialController(Resource):
    def __init__(self,cred_service:CredentialService = CredentialService()):
        self.cred_service = cred_service
    ...
    def post(self):
        ...
        try:
            ...
            res = self.cred_service.gen_otp_admin(req['username'])
            return res
        except Exception as e:
            print(e)
            return jsonify(error_msg)
    ...
    def put(self):
        ...
        try:
            ...
            res = self.cred_service.change_admin_password(req['username'],req['password'],req['otp'])
            return res
        except Exception as e:
            print(e)
            return jsonify(error_msg)